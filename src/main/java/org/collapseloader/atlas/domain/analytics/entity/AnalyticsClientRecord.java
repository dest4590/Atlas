 ...
 * Contains information about a client launch event, including the client, launch timestamp, and platform.
 * Fields:
 ...
 * {@link #platform} - The {@link Platform} platform on which the client was launched.
 */
@Entity
